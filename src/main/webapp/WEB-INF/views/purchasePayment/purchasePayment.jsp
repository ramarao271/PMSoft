	...
	$(function() {
		...
		$("#cityx").autocomplete({
			source : function(request, response) {
				$.ajax({
					url : "/purchasePayment/listPPSuppliers.jsp",
					dataType : "json",
					data : {
						style : "full",
						maxRows : 12,
...
<body onload="loadBranches()">
	...
	<form:form name="paymentForm" method="POST"
		action="/purchasePayment/savePurchasePayment.html"
	...
	<div class="overlay-content popup1">
		<iframe src="/product/ProductSelectionList/purchasePaymentItemBeans"
